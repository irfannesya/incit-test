...
router.get("/user/active", middleware.verifiedEmail, userController.totalActiveUser);
router.get("/user/average", middleware.verifiedEmail, userController.averageActiveUser);
